...
class PosSession(models.Model):
    ...
    def create(self, values):
        ...
        # Editted by Shivam. Allowed permission for franchise user also
        if self.env.user.has_group('point_of_sale.group_pos_user') or self.env.user.has_group('pos_franchise.group_pos_franchise_user'):
            uid = SUPERUSER_ID
        else:
